...
global.JUMP = ini_read_real("controls","jump",20);
global.CLIMB = ini_read_real("controls","climb",16);
global.HAMMER = ini_read_real("controls","hammer",45);
global.SPEAR = ini_read_real("controls","spear",46);
//Secondary Controls
...
global.GP_JUMP = ini_read_real("gamepad","jump",gp_face4);
global.GP_CLIMB = ini_read_real("gamepad","climb",gp_face3);
global.GP_HAMMER = ini_read_real("gamepad", "hammer", gp_shoulderrb);
global.GP_SPEAR = ini_read_real("gamepad","spear", gp_shoulderlb)
